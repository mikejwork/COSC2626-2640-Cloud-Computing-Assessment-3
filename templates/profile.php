...
<section style="padding: 15%;font-family: Ubuntu, sans-serif;border-top: 1px inset rgba(255,255,255,0.07);">
    <div class="container" style="color: rgb(255,255,255);padding: 2%;background: rgba(18,18,18,0);border-radius: 15px;font-family: Ubuntu, sans-serif;">
        <div style="margin-bottom: 5%;">
            ...
            <p style="font-family: Ubuntu, sans-serif;margin-bottom: 5px;margin-left: 25px;border-bottom-color: rgb(255,255,255);">{{user.username}}</p>
            <p style="font-family: Ubuntu, sans-serif;margin-bottom: 5px;margin-left: 25px;">{{user.email}}</p>
            <p style="font-family: Ubuntu, sans-serif;margin-bottom: 5px;margin-left: 25px;">{{user.phonenumber}}</p>
        </div>
        <div>
            <h1 style="font-weight: normal;font-style: normal;font-family: Ubuntu, sans-serif;">Change Password</h1>

            <form action="/changepassword/{{user.userid}}" method="POST" style="margin-bottom: 5px;">
